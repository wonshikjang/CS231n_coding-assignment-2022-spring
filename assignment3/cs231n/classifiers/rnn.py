...
class CaptioningRNN:
    ...
    def loss(self, features, captions):
        ...
        if (self.cell_type == "rnn"):
          hidden_vectors, rnn_cache = rnn_forward(word_vectors, h0,Wx, Wh, b)

        #(4)
        scores, affine_cache2 = temporal_affine_forward(hidden_vectors,W_vocab, b_vocab)
        ...
        #grad(4)
        dh, grads["W_vocab"], grads["b_vocab"] = temporal_affine_backward(dx, affine_cache2)
        ...
        #grad(1) feature : (N,D), W_embed (V,D) -> D,H
